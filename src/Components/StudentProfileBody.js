...
import { Container, Row, Col, Dropdown, Form, Button, Card, Badge } from 'react-bootstrap';
import '../Components/StudentProfileBody.css';

// Import your profile images
import devansh from '../Assets/male.jpg';
import fathima from '../Assets/female.jpg';
...
const StudentProfile = () => {
  ...
  const handleSearch = () => {
    ...
    setTimeout(() => {
      const results = cachedProfiles.filter(profile =>
        profile.id.includes(searchTerm.trim())
      );
    ...
    <main>
                  ...
                  {showFilter && (
                    <div className="filter-toggle-box shadow" style={{ width: "100%", padding: "1rem" }}>
                      ...
                      <div className="mt-4 d-flex justify-content-center">
                        <Button className="w-25 search-btn" onClick={handleSearch}>Search</Button>
                      </div>
                    </div>
                  )}
                </div>
      ...
      {(loading || searchResults.length > 0) && (
        <section className="p-4">
          <h5 className="mb-3 fw-bold">Search Results</h5>
          <Row className="g-3">
            {loading ? (
              ...
              searchResults.map((profile, idx) => (
               <Col key={idx} xs={6} sm={4} md={3} lg={2}>
                  ...
                  <Card className="p-2 text-center shadow-sm" style={{ borderRadius: '0.75rem', border: '1px solid #E2E2E2' }}>
                    <div className="mx-auto mb-2" style={{ width: '6rem', height: '6rem', borderRadius: '50%', overflow: 'hidden', border: '0.375rem solid #FFF', boxShadow: '0 0 0.25rem rgba(0, 0, 0, 0.25)' }}>
                      <img
                        src={profile.avatar}
                        alt={profile.name}
...
<linearGradient id="paint1_linear_1342_505" x1="-2.07601" y1="2.07989" x2="146.967" y2="2.07989" gradientUnits="userSpaceOnUse">
<stop stop-color="#0F6CBD" stop-opacity="0"/>
<stop offset="0.25" stop-color="#0F6CBD"/>
<stop offset="0.500694" stop-color="#0F6CBD"/>
<stop offset="0.75" stop-color="#0F6CBD"/>
<stop offset="1" stop-color="#0F6CBD" stop-opacity="0"/>
                    ...
                    <div className="d-flex justify-content-center gap-2 flex-wrap">
                      {profile.tags.map((tag, i) => (
                        <Badge key={i} bg={tag === 'Current' ? 'success' : 'primary'} className="px-2 py-2  text-white">
                          {tag}
                        </Badge>
                      ))}
                    </div>
      ...
      <section className={`alerts-container border rounded mt-2 p-4 bg-white shadow-sm ${showFilter || loading || searchResults.length > 0 ? 'disabled' : ''}`}>
            ...
            <Col key={index} md={4} className={`border-end ${index === 2 ? 'border-end-0' : ''}`}>
              <div className="d-flex align-items-start gap-2 pe-3">
                ...
                <div>
                  ...
                  <p className="mb-0 text-muted">{alertText}</p>
                </div>
              </div>
            </Col>
          ))}
